...
class MeetingTaggedUsersSelectAdapter(menuItems: List<TaggedUsers>, private val onSelectListener: GroupSelectedListener) : RecyclerView.Adapter<MeetingTaggedUsersSelectAdapter.ViewHolder>() {

    private val selectedUsers = mutableSetOf<TaggedUsers>()
    ...
    fun updateList(newList: List<TaggedUsers>) {
        filteredList.clear()
    ...
    interface GroupSelectedListener {
        fun onGroupSelectListener(groups: TaggedUsers, isSelected: Boolean)
    }
}
