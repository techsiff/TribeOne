...
class PDFFolderDetailsAdapter(pdfDetails: List<CategoryList>, private val pdfDetailsListener: PDFDetailsListener, private val isAdmin: Boolean) : RecyclerView.Adapter<PDFFolderDetailsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mPDFTitle.text = pdfData.name
        holder.mPDFBy.text = "by ${pdfData.createdBy}"
        ...
        holder.mPDFIcon.setImageResource(R.drawable.ic_pdf_folder)
    }
    ...
    class ViewHolder(mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mPDFIcon: ImageView = mView.findViewById<View>(R.id.pdf_view) as ImageView
    ...
    interface PDFDetailsListener {
        fun onClickNext(pdfDetails: CategoryList?)
        fun onDelete(pdfDetails: CategoryList?)
    }
}
