...
class SharedPlaylistsAdapter(private val mContext: Context, private val playLists: List<SharedPlaylist>, private val videoDetailsListener: VideoDetailsListener) : RecyclerView.Adapter<SharedPlaylistsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mVideoBy.text = "shared by ${video.sharedUserName}"
        Glide.with(mContext)
    ...
    interface VideoDetailsListener {
        fun onClickNext(playLists: SharedPlaylist)
    }
}
