...
class BlockedUserAdapter(private val userList: ArrayList<String>, private val onSelectListener: CommunityUserGroupListener) : RecyclerView.Adapter<BlockedUserAdapter.ViewHolder>() {
    ...
    interface CommunityUserGroupListener {
        fun onUserSelectListener(users: String)
    }
}
