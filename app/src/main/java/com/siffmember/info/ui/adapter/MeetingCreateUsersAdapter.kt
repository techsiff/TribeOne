...
class MeetingCreateUsersAdapter(menuItems: List<MembersGroup>, private val onSelectListener: MeetingCreateUsersListener) : RecyclerView.Adapter<MeetingCreateUsersAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        fun bind(itemData: MembersGroup){
            ...
            mUserCard.setOnClickListener{
                onSelectListener.onUserUpdateListener(itemData)
            }
        }
    }
    @SuppressLint("NotifyDataSetChanged")
    fun updateList(newList: List<MembersGroup>) {
        filteredList.clear()
        filteredList.addAll(newList)
        notifyDataSetChanged()
    }
    interface MeetingCreateUsersListener {
        fun onUserUpdateListener(users: MembersGroup)
    }
}
