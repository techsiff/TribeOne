...
class MeetingParticipantsAdapter(var isAdmin: Boolean, var adminId: String, private val menuItems: ArrayList<MembersZoomMeeting>, private val onSelectListener: CommunityUserGroupListener) : RecyclerView.Adapter<MeetingParticipantsAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        fun bind(itemData: MembersZoomMeeting){

            if(adminId == itemData.id){
                mTitle.text = "You"
            } else {
            ...
            if(isAdmin){
                ...
                mDelete.visibility = View.GONE
                mNumber.visibility = View.INVISIBLE
            }
            mNumber.text = itemData.id
    ...
    interface CommunityUserGroupListener {
        fun onUserSelectListener(users: MembersZoomMeeting)
    }
}
