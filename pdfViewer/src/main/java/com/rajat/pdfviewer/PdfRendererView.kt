...
import com.rajat.pdfviewer.PdfViewerActivity.Companion.TAG
...
class PdfRendererView @JvmOverloads constructor(
    ...
    fun initWithUrl(url: String, headers: HeaderData = HeaderData(), lifecycleCoroutineScope: LifecycleCoroutineScope, lifecycle: Lifecycle) {
        ...
        PdfDownloader(lifecycleCoroutineScope,headers,url, object : PdfDownloader.StatusListener {
            ...
            override fun onDownloadSuccess(absolutePath: String) {
                Log.e(TAG,"onDownloadSuccess $absolutePath")
